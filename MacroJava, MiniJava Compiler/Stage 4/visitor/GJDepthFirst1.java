...
public class GJDepthFirst1<R,A> implements GJVisitor<R,A> {
   ...
   public GJDepthFirst1( HashMap<String, HashMap<String, Integer>>  __labelLine ){
   ...
   public void procBegin(){
      labelLine.put(procLabel, new HashMap<>());
      counter = 0;
      counter += argCnt;
   }
   ...
   public R visit(Label n, A argu) {
      ...
      if(label) labelLine.get(procLabel).put(LABEL, counter);
      return (R) LABEL;
   }
}
